...
/* Tag nicht über den Kopf: bei Porträt unten links in die freie Fußzeile,
   klar weg vom Gesicht rechts (statt oben rechts neben dem Kopf). */
.frame.has-portrait .top{justify-content:flex-start}
.frame.has-portrait .tag{position:absolute;left:72px;bottom:60px;align-self:auto;text-align:left;font-size:16px}
`;
};
