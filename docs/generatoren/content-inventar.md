...
| `impulses.ts` | Wöchentliche E-Mail-Impulse | **8** | (E-Mail-Runtime) |
...
**`content/vorlagen/thumbs/`** — `reels/` 59 `.webp`, `social/` 105 `.webp`.

**`content/vorlagen/social/`** — 105 `.webp` (`social-001 … social-105`).
...
- `docs/skripte/` — **68 MD** (Marketing-Rohtexte): carousels 5, landing 2,
...
- `docs/marketing/` — 105 PNG + Generator-Skripte (nach Kanal gruppiert).
...
| Social-Grafiken | 105 (+ 105 Thumbs) |
| Mitglieder-PDFs (`content/pdf/`) | 44 |
| Workshop-Materialien | 39 |
| Marketing-Rohtext-Skripte (`docs/skripte/`) | 68 MD |
