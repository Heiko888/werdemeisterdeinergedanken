    ...
    >
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-20">
        <Image
          ...
          priority={false}
          sizes="100vw"
          className="h-full w-full object-cover object-center opacity-60 [-webkit-mask-image:linear-gradient(to_bottom,#000_0%,rgba(0,0,0,0.55)_60%,transparent_100%)] [mask-image:linear-gradient(to_bottom,#000_0%,rgba(0,0,0,0.55)_60%,transparent_100%)]"
        />
      </div>
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, color-mix(in oklab, var(--color-navy-900) 42%, transparent) 0%, color-mix(in oklab, var(--color-navy-900) 68%, transparent) 100%)",
        }}
      />
