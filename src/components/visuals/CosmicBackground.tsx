...
export function CosmicBackground({
  ...
  return (
    ...
    >
      ...
      {/* Leucht-Orbs */}
      <div className="absolute -left-24 top-[-10%] h-[28rem] w-[28rem] rounded-full bg-gold-400/18 blur-[90px] animate-pulse-slow" />
      <div className="absolute right-[-10%] top-[6%] h-[26rem] w-[26rem] rounded-full bg-gold-600/22 blur-[100px] animate-pulse-slow" />
      {variant === "hero" && (
