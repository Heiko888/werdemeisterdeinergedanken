  ...
  return (
    <button
      ...
      className={cn(
        ...
        "bg-gradient-to-r from-gold-400 to-gold-500 text-navy-950 shadow-soft ring-1 ring-white/20",
        "transition-all duration-300 hover:from-gold-500 hover:to-gold-600 hover:-translate-y-0.5",
