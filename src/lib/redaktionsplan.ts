...
function mkWeekA(s: SpecA): PlanPost[] {
  return [
    ...
    { wochentag: 5, uhrzeit: "07:30", kanal: "li", format: "🎯 Pitch", titel: `„${s.pitch}“ Soft-Pitch E-Book „Die 7 Stufen der Bewusstseinsentwicklung“.`, quelle: "Funnel /#ebook", cta: "E-Book laden" },
