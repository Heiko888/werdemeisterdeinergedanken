...
const CSS = `
${fontsCss}
:root{ --ink:#16231f; --mid:#48524e; --leaf:#7e6410; --teal:#7e6410; }
@page{ size:A4; margin:22mm 20mm; }
*{ box-sizing:border-box; }
body{ margin:0; font-family:'Inter',system-ui,sans-serif; color:var(--ink); font-size:13.5pt; line-height:1.7; background:#f6f4ee; }
...
p.regie{ font-family:ui-monospace,'SF Mono',Menlo,monospace; font-size:10pt; color:#48524e; background:#efece2;
