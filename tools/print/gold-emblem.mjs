 ...
 *
 * Quelle ist das **echte** goldene Logo-Emblem `public/logo-brain-gold-freigestellt.png`
 ...
 * „vergoldet". Seit dem echten Gold-Logo entfällt das – logo-brain-gold-freigestellt.png ist
...
const src = join(ROOT, "public/logo-brain-gold-freigestellt.png");
if (!existsSync(src)) throw new Error("public/logo-brain-gold-freigestellt.png fehlt (echtes Gold-Emblem).");
...
console.log("✓ public/email/wmdg-signatur-logo.png (240 px, aus logo-brain-gold-freigestellt.png)");
