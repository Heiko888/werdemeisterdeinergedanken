// Einzel-Story „Papa, kannste mal erklären?" (9:16, 1080x1920).
// Hook-Story im Marken-Look: zentrierter Aufbau (Text oben, Figur mittig-unten),
// einladende „offene Hand"-Pose, Gold-Kursiv auf dem Schlüsselwort.
...
const ITEM = {
  key: "papa-erklaeren",
  pose: "offeneHand",
  q: `Papa, kannste<br>mal <em>erkl&auml;ren</em>?`,
};
...
fs.writeFileSync(path.join(BUILD, `papa-${ITEM.key}-9x16.html`), page("9x16", ITEM, bg));
console.log(`Story „Papa, kannste mal erklären?": 1 Seite -> tools/social/weisheiten/build/`);
