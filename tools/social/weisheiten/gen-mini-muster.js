// Mini-Serie „Muster & Vermeidung": frontale Gesten-Posen (nichts sehen/hören/
// sagen, ratlos, Schulterzucken) mit eigenen Weisheiten. Zentrierter Aufbau
// (Text oben, Figur mittig-unten). Erzeugt je Motiv 4:5 (1080x1350) und 9:16 (1080x1920).
...
// Silhouetten-Boxen der 5 Gesten-Posen
const BBOX = {
  kopfkratzen:    { minx: 194, maxx: 786, miny: 46, maxy: 1482 },
  augenZu:        { minx: 166, maxx: 836, miny: 30, maxy: 1454 },
  ohrenZu:        { minx: 108, maxx: 862, miny: 22, maxy: 1444 },
  mundZu:         { minx: 184, maxx: 804, miny: 42, maxy: 1480 },
  schulterzucken: { minx: 78,  maxx: 934, miny: 34, maxy: 1486 },
};

// 5 Motive: Pose + Weisheit (kurze Zeilen, 1–2 goldene Schlüsselwörter)
const ITEMS = [
